...
module.exports = function () {
  var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(program) {
    var detect, port, compiler, listener, prepareUrls, printInstructions, host, isFirstCompile;
    return _regenerator2.default.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 8:
            host = listener.address().address === `127.0.0.1` ? `localhost` : listener.address().address;
            isFirstCompile = true;
